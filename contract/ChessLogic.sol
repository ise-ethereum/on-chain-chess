...
library ChessLogic {
  ...
  function Directions(Direction i) internal view returns (int8) {
  ...
  function getDirection(uint256 fromIndex, uint256 toIndex) internal view returns (int8) {
  ...
  function boolToInt(bool value) private pure returns (int) {
    if (value) {
      return 1;
    } else {
      return 0;
